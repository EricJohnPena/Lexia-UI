...
error_log("Received parameters: student_id=$student_id, lesson_id=$lesson_id, game_mode_id=$game_mode_id, subject_id=$subject_id, speed=$speed");

if ($student_id === 0 || $lesson_id === 0 || $game_mode_id === 0 || $subject_id === 0 || $speed === 0) {
...
if ($checkStmt->num_rows > 0) {
    ...
    $updateStmt->bind_param("iiiii", $speed, $student_id, $lesson_id, $game_mode_id, $subject_id);
    ...
    $insertQuery = "
        INSERT INTO students_progress_tbl (student_id, lesson_id, fk_game_mode_id, fk_subject_id, speed)
        VALUES (?, ?, ?, ?, ?)
    ";
    $insertStmt = $conn->prepare($insertQuery);
    $insertStmt->bind_param("iiiii", $student_id, $lesson_id, $game_mode_id, $subject_id, $speed);
