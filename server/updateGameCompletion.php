...
if ($student_id === 0 || $lesson_id === 0 || $game_mode_id === 0 || $subject_id === 0 || $solve_time === 0) {
...
if ($result->num_rows > 0) {
    ...
    $updateStmt->bind_param("iiiii", $solve_time, $student_id, $lesson_id, $game_mode_id, $subject_id);
    ...
    $insertQuery = "
        INSERT INTO students_progress_tbl (student_id, lesson_id, fk_game_mode_id, fk_subject_id, no_of_attempts, completion_status, solve_time)
        VALUES (?, ?, ?, ?, 1, 'completed', ?)
    ";
    $insertStmt = $conn->prepare($insertQuery);
    $insertStmt->bind_param("iiiii", $student_id, $lesson_id, $game_mode_id, $subject_id, $solve_time);
